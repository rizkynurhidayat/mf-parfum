            ...
            @endif
              <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="card-header">Hero Section Data</h5>
                    <a class="btn btn-primary" href="{{ route ('hero.create') }}">Add Hero Sect</a>
                </div>
                             ...
                             @if (Storage::disk('public')->exists($hero->image))
                                <div class="col-md-6 col-lg-4 mb-3">
                                    <div class="card h-100">
                                        <img class="card-img-top" src="{{ asset('storage/' .$hero->image) }}" alt="Card image cap" />
                                        <div class="card-body">
                                        </div>
                                    </div>
                                </div>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('hero.edit', $hero) }}"
